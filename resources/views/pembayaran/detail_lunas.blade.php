                    ...
                    <div class="invoice p-3 mb-3">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <h4 style="text-align: center"><i>Lunas</i></h4>
                                <h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-7">
                                ...
                                <h6><strong class="text-capitalize">Terbilang :
                                        {{ \Nasution\Terbilang::convert($invoice['down_payment'] + $invoice['price_invoice']) }}
                                        Rupiah</strong></h6>
                                </p>
                            </div>
                            <!-- /.col -->
                          ...
                          <td><b>Rp.&emsp;<i>{{number_format($invoice->pemesanan['total'], 0, ",", "."); }}</i></b></td>
                                        ...
                                        <tr>
                                            <th style="width:60%">Pembayaran Lunas</th>
                                            <td style="width:5%">:</td>
                                            <td style="width:35%; text-align-last: left"><b>Rp.&emsp;
                                                    {{ number_format($invoice['down_payment'] + $invoice['price_invoice'], 0, ',', '.') }}</b>
                                            </td>
