              ...
              <div class="invoice p-3 mb-3">
                ...
                <div class="row">
                  ...
                  <div class="col-7">
                    ...
                    {{-- <p><h6><strong class="text-capitalize">Terbilang : {{\Nasution\Terbilang::convert($total_ammount-$invoice['down_payment'])}} Rupiah</strong></h6></p>--}}
                     <p><h6><strong class="text-capitalize">Terbilang : {{\Nasution\Terbilang::convert($invoice['down_payment'])}} Rupiah</strong></h6></p>
                  </div>
                  <!-- /.col -->
                  <div class="col-5">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        <tr>
                            ...
                            <td><b>Rp.&emsp;<i>{{number_format($invoice->pemesanan['total'], 0, ",", "."); }}</i></b></td>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><b>Rp.&emsp;<i>{{number_format($total_ammount-$invoice['down_payment'], 0, ",", "."); }}</i></b></td>
                        </tr>
                ...
                <div class="row no-print">
                  <div class="col-12 mt-1 mr-4 mb-2">
                      ...
                      @endif
                      <a href="/pembayaran/lunas" class="btn btn-secondary float-lg-left">Kembali</a>
