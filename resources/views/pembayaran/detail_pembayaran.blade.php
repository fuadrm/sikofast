                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="width: 50%">
                                                ...
                                                {{ @$doszs->szs_m == null ? '' : 'Size M Pendek : ' . @$doszs->szs_m . ' pcs,' }}&emsp;&emsp;
                                                {{ @$doszs->szs_l == null ? '' : 'Size L Pendek : ' . @$doszs->szs_l . ' pcs,' }}<br>

                                                {{ @$doszs->szs_xl == null ? '' : 'Size XL Pendek : ' . @$doszs->szs_xl . ' pcs,' }}&emsp;&emsp;
                                                {{ @$doszs->szs_2xl == null ? '' : 'Size 2XL Pendek : ' . @$doszs->szs_2xl . ' pcs,' }}&emsp;&emsp;
                                                {{ @$doszs->szs_3xl == null ? '' : 'Size 3XL Pendek : ' . @$doszs->szs_3xl . ' pcs,' }}<br>

                                                {{ @$doszs->szs_4xl == null ? '' : 'Size 4XL Pendek : ' . @$doszs->szs_4xl . ' pcs,' }}
                                                ...
                                                {{ @$doszl->szl_m == null ? '' : 'Size M Panjang : ' . @$doszl->szl_m . ' pcs,' }}&emsp;&emsp;
                                                {{ @$doszl->szl_l == null ? '' : 'Size L Panjang : ' . @$doszl->szl_l . ' pcs,' }}<br>

                                                {{ @$doszl->szl_xl == null ? '' : 'Size XL Panjang : ' . @$doszl->szl_xl . ' pcs,' }}&emsp;&emsp;
                                                {{ @$doszl->szl_2xl == null ? '' : 'Size 2XL Panjang : ' . @$doszl->szl_2xl . ' pcs,' }}&emsp;&emsp;
                                                {{ @$doszl->szl_3xl == null ? '' : 'Size 3XL Panjang : ' . @$doszl->szl_3xl . ' pcs,' }}<br>

                                                {{ @$doszl->szl_4xl == null ? '' : 'Size 4XL Panjang : ' . @$doszl->szl_4xl . ' pcs,' }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-7">
                                ...
                                <h6><strong class="text-capitalize">Terbilang :
                                        {{ \Nasution\Terbilang::convert($invoice->pemesanan['total']) }} Rupiah</strong>
                                </h6>
                                </p>
                            </div>
                            <!-- /.col -->
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:5%">:</td>
                                            <td style="width:35%; text-align-last: left"><b>Rp.&emsp;&emsp;
                          ...
                          <td>-</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td><b>Rp.&emsp;&emsp;<i>{{ number_format($total_ammount - $invoice['down_payment'], 0, ',', '.') }}</i></b>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Total</th>
                                            ...
                                            <td><b>Rp.&emsp;&emsp;<i>{{ number_format($invoice->pemesanan['total'], 0, ',', '.') }}</i></b>
                                            </td>

                                        </tr>
                                        {{-- <tr>
                          <th style="width:60%">Pelunasan</th>
                          <td style="width:5%">:</td>
                          <td style="width:35%; text-align-last: left"><b>Rp.&emsp;&emsp;
                            {{number_format($invoice['down_payment']+
                              $invoice['price'], 0, ",", "."); }}</b></td>
                          <td style="width:35%; text-align-last: left"><b>Rp.&emsp;&emsp;
                            <i>{{number_format($invoice['price'], 0, ",", "."); }}</i></b></td>
                        </tr> --}}
                                    </table>
                                </div>
                            </div>
