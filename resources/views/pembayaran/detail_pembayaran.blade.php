              ...
              <div class="invoice p-3 mb-3">
                ...
                <div class="row invoice-info">
                  ...
                  <div class="col-sm-4 invoice-col">
                    ...
                    <br>
                    <b>No PO</b> <b style="font-size: 18px">&emsp;&emsp;&ensp; :  {{$invoice->pemesanan->no_po}}</b><br>
                    ...
                    <table class="table table-striped">
                      ...
                      <tr>
                        <td style="width: 50%">
                          ...
                          {{@$doszl->szl_m == null ? '':'Size S Panjang : '.@$doszl->szl_m . ' pcs,'}}&emsp;&emsp;
                        ...
                        <td style="text-align: center; width:15% ">
                          ...
                          {{ "Rp " . number_format($invoice->pemesanan->tipe['price_service']+
                          $invoice->pemesanan->bahan['price_material'], 0, ",", "."); }}
                        ...
                        <td style="text-align: center; width:15%">
                          ...
                          <?php 
                          $ammount = $invoice->pemesanan->qty * ($invoice->pemesanan->tipe['price_service']+
                          $invoice->pemesanan->bahan['price_material']);
                ...
                <div class="row">
                  ...
                  <div class="col-7">
                    ...
                    <p><h6><strong class="text-capitalize">Terbilang : {{\Nasution\Terbilang::convert($invoice->pemesanan['total'])}} Rupiah</strong></h6></p>
                  </div>
                  <!-- /.col -->
                  <div class="col-5">
                      ...
                      <table class="table">
                        ...
                        <tr>
                          ...
                          <td style="width:35%; text-align-last: left"><b>Rp.&emsp;&emsp;
                            <i>{{number_format($invoice['down_payment'], 0, ",", "."); }}</i></b></td>
                        </tr>
                        {{-- <tr>
                          <th>Discount</th>
                        ...
                        <tr>
                          ...
                          <td>:</td>
                          <td><b>Rp.&emsp;&emsp;<i>{{number_format($total_ammount-$invoice['down_payment'], 0, ",", "."); }}</i></b></td>
                        </tr>
                        <tr>
                          <th>Total</th>
                          <td>:</td>
                          {{-- <td><b>Rp.&emsp;&emsp;<i>{{number_format($total_ammount, 0, ",", "."); }}</i></b></td> --}}
                          <td><b>Rp.&emsp;&emsp;<i>{{number_format($invoice->pemesanan['total'], 0, ",", "."); }}</i></b></td>
                    ...
                    <div class="table-responsive">
                      <table width="100%">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td style="text-align: center; width: 50%"><br><br><br><strong>(_____________)</strong></td>
                            <td style="text-align: center; width: 50%"><br><br><br><strong>(_____________)</strong></td>
                          </tr>
                        </tbody>
                      </table>
