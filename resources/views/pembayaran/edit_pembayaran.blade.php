                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input name="" class="form-control"
                                                value="{{ old('no_inv', $invoice->no_inv) }}" readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="down_payment" class="form-control"
                                                value="{{ old('down_payment', $invoice->down_payment) }}" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input name="" class="form-control"
                                                value="{{ $invoice->pemesanan->no_po }}" readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="down_payment" class="form-control"
                                                value="{{ $invoice->pemesanan->total }}" readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="" name="" class="form-control"
                                                    ...
                                                    value="{{ old('created_at', $invoice->created_at) }}" readonly>
        ...
        <script>
            ...
            $('#price_invoice').on('change', () => {
                ...
                if (validate > 0) {
                    ...
                    alert('Sisa Pelunasan Kurang dari total pembayaran')
                } else {
                    $('#price_invoice').val(Number(total) - Number(dp))
                    alert('Sisa Pelunasan Lebih dari total pembayaran')
                }
